...
db.exec(`    CREATE TABLE IF NOT EXISTS goal_claims (
...
db.exec(`    CREATE TABLE IF NOT EXISTS goal_completions (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        user_id INTEGER NOT NULL,
        goal TEXT NOT NULL,
...
db.exec(`    CREATE TABLE IF NOT EXISTS cp_points (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
...
db.exec(`    CREATE TABLE IF NOT EXISTS ad_progress (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        user_id INTEGER NOT NULL UNIQUE,
